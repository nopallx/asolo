...
DECODED & CRACKED BY BL4CK SILENT
Sumatra, Indonesia
...
echo "                ======    =======     ====================== ========\e[0m\r\n";
echo "                \e[101m                                                     \r\n";
echo "\e[0m         BL4CK SENDER  GX40 SENDER RECODE BY MBENDOL -  INDONESIANDARKNET\r\n";
echo "                \e[107m                                                     \r\n";
echo "\e[0m                ======    =======     ===============  ==============\r\n";
echo "                I::::I    D:::::D     D:::::DN::::::N   N:::::::::::N\r\n";
echo "                I::::I    D:::::D     D:::::DN::::::N    N::::::::::N\r\n";
...
function Kirim($email, $smtp_acc, $gx_setup)
{
    ...
    if ($file) {
        ...
        foreach ($ext as $num => $email) {
            ...
            if ($smtp_key == count($smtp_acc) && function_exists('smtp_connection')) {
                $smtp_key = 0;
            }
            //kirim
